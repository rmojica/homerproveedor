...
var OrdersPage = /** @class */ (function () {
    function OrdersPage(socket, navCtrl, navParams, values, productService, modalCtrl, loadingCtrl) {
        this.socket = socket;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.values = values;
