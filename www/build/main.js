...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_service_category_service__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_service_category_service__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__dash_proveedor_dash_proveedor__ = __webpack_require__(193);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AccountLogin = /** @class */ (function () {
    ...
    AccountLogin.prototype.ionViewLoaded = function () {
        var _this = this;
        setTimeout(function () {
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('inputUser'),
        __metadata("design:type", Object)
    ], AccountLogin.prototype, "myInput", void 0);
    AccountLogin = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"D:\desktop\numu\homer\homerproveedor\src\pages\account\login\login.html"*/'<!-- Header -->\n<ion-header class="header" no-shadow no-border>\n  <ion-toolbar color="header">\n    <button ion-button menuToggle>\n      <ion-icon>\n        <img class="logo-login" style="width: 60%;" src="{{values.iconMenu}}">\n      </ion-icon>\n    </button>\n  </ion-toolbar>\n</ion-header>\n<ion-content class="account-login">\n  <!-- <img class="header-login" src="{{values.headerLogin}}"> -->\n  <div class="header-login">\n    <div><img src="{{values.logoLogin2}}"></div>\n    <div class="margin">\n      <!-- <div>\n      <img class="logo-login" style="width: 70%;" src="{{values.logoLogin}}">\n    </div> -->\n      <form #f="ngForm" class="login">\n        <ion-list>\n          <ion-item>\n            <ion-label floating>{{"Usuario" | translate}}</ion-label>\n            <ion-input #inputUser required type="email" [(ngModel)]="loginData.username" name="firstname">\n            </ion-input>\n          </ion-item>\n\n          <!-- <ion-item>\n          <ion-input [type]="getType()" required type="password" [(ngModel)]="loginData.password" name="password" placeholder="Password"></ion-input>\n        <ion-icon name="eye" item-right (click)="toggleTextPassword()"></ion-icon>\n\n        </ion-item> -->\n          <ion-item>\n            <ion-label floating>{{"Contraseña" | translate}}</ion-label>\n            <ion-input class="pass" required [type]="passwordType" clearOnEdit="false" [(ngModel)]="loginData.password"\n              name="password"></ion-input>\n            <ion-icon item-end [name]="passwordIcon" class="passwordIcon" (click)=\'hideShowPassword()\'></ion-icon>\n          </ion-item>\n\n        </ion-list>\n\n        <div class="margin">\n          <button ion-button clear color="button-color" type="submit"\n            class="forgot-pass button button-block button-clear" text-uppercase (click)="forgotten()">{{"Has olvidado tu contraseña?" |\n            translate}}\n            ?\n          </button>\n          <br>\n          <div class="button-center">\n            <button ion-button block color="button-color" type="submit" class="button button-block button-default"\n              text-uppercase [disabled]="disableSubmit" (click)="login(loginData)">{{"Iniciar Sesión" | translate}}\n            </button>\n          </div>\n        </div>\n      </form>\n    </div>\n  </div>\n</ion-content>\n'/*ion-inline-end:"D:\desktop\numu\homer\homerproveedor\src\pages\account\login\login.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["NavController"],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__booking_details_booking_details__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ngx_translate_core__ = __webpack_require__(100);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_rxjs_add_observable_forkJoin__ = __webpack_require__(170);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_http__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_service_functions__ = __webpack_require__(24);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var Service = /** @class */ (function () {
    ...
    Service.prototype.updateProduct = function (data, product) {
        ...
        return new Promise(function (resolve) {
            _this.reqhttp
                .put(_this.config.setUrl('PUT', "/wp-json/wc-bookings/v1/products/" + product + "?consumer_key=" + _this.config.consumerKey + "&consumer_secret=" + _this.config.consumerSecret, false), data, {})
                .then(function (data) {
    ...
    Service.prototype.addProduct = function (data) {
        ...
        return new Promise(function (resolve) {
            ...
            _this.http
                .post(_this.config.url + ("/wp-json/wc-bookings/v1/products?consumer_key=" + _this.config.consumerKey + "&consumer_secret=" + _this.config.consumerSecret), {
                'name': data.name,
                'slug': data.slug,
                'status': data.status,
                ...
                .map(function (res) { return res.json(); })
                .subscribe(function (data) {
                var response = _this.updateProductWithVendor(data.id);
                resolve(response);
            });
        }).catch(function (error) {
            console.log("viendo error1", error.status);
    ...
    Service.prototype.updateProductWithVendor = function (post_id) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.reqhttp.put(_this.config.url + "/wp-admin/admin-ajax.php?vendor=" + _this.values.customerId + "&post_id=" + post_id + "&action=mstoreapp-update_product_author", {}, {}).then(function (data) {
                resolve(data);
            }).catch(function (error) {
                console.log("viendo error1", error.status);
                console.log("viendo error1", error.error); // error message as string
        ...
        return new Promise(function (resolve) {
            _this.http
                ...
                if (data.statusText == "OK") {
                    ...
                    _this.functions.showAlert("ERROR", "ha ocurrido un error por favor verifique.");
            });
        });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_Rx__ = __webpack_require__(179);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__products_products__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_service_category_service__ = __webpack_require__(38);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_category_service__ = __webpack_require__(38);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_ngx_socket_io__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_native_geolocation_ngx__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_native_geocoder__ = __webpack_require__(83);
...
var DashProveedorPage = /** @class */ (function () {
    function DashProveedorPage(serv, service, nativeGeocoder, platform, backgroundMode, socket, navCtrl, navParams, values, geolocation, oneSignal) {
        var _this = this;
        this.serv = serv;
        this.service = service;
        ...
        this.service.getProductsByIdVendor2()
            ...
            _this.socket.emit('adduser', {
                id: _this.values.customerId,
                lat: _this.miLatitude,
                lng: _this.miLongitude,
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ngx_socket_io__ = __webpack_require__(81);
...
var EditAddressForm = /** @class */ (function () {
    function EditAddressForm(nav, service, params, values, navCtrl) {
        var _this = this;
        this.nav = nav;
        this.service = service;
        this.values = values;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_http__ = __webpack_require__(99);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__cart_cart__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__products_products__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__search_search__ = __webpack_require__(111);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_service_category_service__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_in_app_browser__ = __webpack_require__(177);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__cart_cart__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__product_product__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__products_products__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__order_summary_order_summary__ = __webpack_require__(190);
...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.getProductsByIdVendor2 = function () {
        ...
        return new Promise(function (resolve) {
            _this.http
                .get(_this.config.url +
                '/wp-json/custom-api/v1/get_products_by_id?id_vendor=' + _this.values.customerId + '', _this.config.options).map(function (res) { return res.json(); }).subscribe(function (data) {
                _this.productsIds = data;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_product_service__ = __webpack_require__(192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_functions__ = __webpack_require__(24);
...
var ProductPage = /** @class */ (function () {
    function ProductPage(translate, nav, service, params, functions, values) {
        ...
        if (params.data.id) {
            ...
            this.product.product.images.map(function (res) { return console.log(res); });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ngx_socket_io__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_product_service__ = __webpack_require__(192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_rxjs__ = __webpack_require__(179);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__chat_chat__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_service_functions__ = __webpack_require__(24);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var OrdersPage = /** @class */ (function () {
    function OrdersPage(socket, navCtrl, navParams, values, productService, modalCtrl, loadingCtrl, functions) {
        this.socket = socket;
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.values = values;
    ...
    OrdersPage.prototype.openchat = function (order) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_8__chat_chat__["a" /* ChatPage */], { order: order });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_geolocation_ngx__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_native_geocoder__ = __webpack_require__(83);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var OrdersDetailPage = /** @class */ (function () {
    ...
    OrdersDetailPage.prototype.goHome = function () {
        this.navCtrl.popToRoot();
    };
    OrdersDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-orders-detail',template:/*ion-inline-start:"D:\desktop\numu\homer\homerproveedor\src\pages\orders-detail\orders-detail.html"*/'<!--\n\n  Generated template for the OrdersPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header style="background-color: #72A9AE;">\n\n  <ion-toolbar color="header">\n\n    <ion-buttons slot="start">\n\n      <button ion-button icon-only  (click)="goHome()">\n\n        <ion-icon name="arrow-back"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title class="logo-title" (click)="goHome()">\n\n      <img width="150" src="{{values.homerLogoP}}" />\n\n    </ion-title>\n\n  </ion-toolbar>\n\n</ion-header>\n\n<ion-content>\n\n  <div id=\'map\' style=\'width: 100%; height: 500px;\'></div>\n\n  <!-- <div class="card" *ngFor="let orders of data">\n\n    <div class="card-body">\n\n      <div class="row-h2">\n\n        <h2>\n\n          <b>Booking # {{orders.id}}</b>\n\n        </h2>\n\n        <h2>\n\n         <b> {{orders.date | date: \'fullDate\' }}, {{orders.hour}} </b>\n\n        </h2>\n\n      </div>\n\n      <h2 style="text-align: right;">\n\n        <b>{{orders.status}}</b>\n\n      </h2>\n\n      <h2 style="text-align: center; font-size: 20px;">\n\n        <b>{{orders.productName}}</b>\n\n      </h2>\n\n      <h2 style="text-align: left;">\n\n        <ul>\n\n          <li><b>{{orders.location}}</b></li>\n\n        </ul>\n\n      </h2>\n\n\n\n    </div>\n\n  </div> -->\n\n  <div class="card" *ngFor="let orders of data">\n\n    <div class="card-body">\n\n      <div class="row-h2">\n\n        <h2 class="numbook">\n\n          <b style="text-transform: uppercase; margin-left: 15px;">Estado: {{orders.status}}</b><br>\n\n          <b>Reserva # {{orders.bookingId}}</b>\n\n        </h2>\n\n        <!-- <h2 class="status">\n\n          \n\n        </h2> -->\n\n      </div>\n\n      <h2 class="orderDate">\n\n       <b>Fecha: {{orders.date  | date: \'dd/MM/yy\' }}</b><br>\n\n       <b>Horario: {{orders.hour | date: \'shortTime\'}} - {{orders.hour_end | date: \'shortTime\'}}</b>\n\n      </h2>\n\n      <div class="rectangle">\n\n        <h2 style="margin:0 auto; width: 80%; font-size: 16px; ">\n\n          <b>Homer: {{orders.productName}}</b>\n\n        </h2>\n\n        <h5 style="margin:0 auto; width: 80%">\n\n          <b>Dirección: {{orders.location}}</b>\n\n        </h5>\n\n      </div>\n\n      <h2 style="text-align: center;" *ngIf="orders.isCancel != \'\' ">\n\n        <b>{{orders.isCancel}}</b>\n\n      </h2>\n\n    </div>\n\n  </div>\n\n</ion-content>'/*ion-inline-end:"D:\desktop\numu\homer\homerproveedor\src\pages\orders-detail\orders-detail.html"*/,
        }),
...
var EndOrdersPage = /** @class */ (function () {
    ...
    EndOrdersPage.prototype.goHome = function () {
        this.navCtrl.pop();
    };
    EndOrdersPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-end-orders',template:/*ion-inline-start:"D:\desktop\numu\homer\homerproveedor\src\pages\end-orders\end-orders.html"*/'<!--\n\n  Generated template for the OrdersPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header style="background-color: #72A9AE;">\n\n  <ion-toolbar color="header">\n\n    <ion-buttons slot="start">\n\n      <button ion-button icon-only (click)="goHome()">\n\n        <ion-icon name="arrow-back"></ion-icon>\n\n      </button>\n\n    </ion-buttons>\n\n    <ion-title class="logo-title" (click)="goHome()">\n\n      <img width="150" src="{{values.homerLogoP}}" />\n\n    </ion-title>\n\n  </ion-toolbar>\n\n</ion-header>\n\n<ion-content>\n\n  <div class="sub-header">\n\n    <h1>Servicios Pasados</h1>\n\n  </div>\n\n  <div class="card" *ngFor="let order of orders">\n\n    <div class="card-body">\n\n      <div class="row-h2">\n\n        <h2 class="numbook">\n\n          <b>Reserva # {{order.bookingId}}</b>\n\n        </h2>\n\n        <h2 id="status" style="text-align: center; padding:7px; width: 70%;\n\n          color: #000; border-radius: 20px; font-size: 10px!important;\n\n          font-family: Arial, Helvetica, sans-serif !important;\n\n          font-weight: 700 !important;">\n\n          <b style="text-transform: uppercase; margin-left: 15px;">{{order.status}}</b>\n\n        </h2>\n\n      </div>\n\n      <h2 class="orderDate">\n\n        <h2>\n\n          <b>Fecha de solicitud: </b> <br>{{order.date | date: \'dd/MM/yy\' }}\n\n        </h2>\n\n        <h2>\n\n          <b>Horario de la reserva: </b> <br>{{order.hour}} a\n\n          {{order.hour_end}}\n\n        </h2>\n\n      </h2>\n\n      <div class="rectangle">\n\n        <h2 style="margin:0 auto; width: 80%; font-size: 16px;">\n\n          <b>{{order.productName}}</b>\n\n        </h2>\n\n        <h5 style="margin:0 auto; width: 80%;">\n\n          <b>{{order.location}}</b>\n\n        </h5>\n\n      </div>\n\n      <div class="rectangle-inverso" *ngIf="order.status == \'cancelado\' &&\n\n        order.isCancel != \'\'">\n\n        <h2>\n\n          <b>{{order.isCancel}}</b>\n\n        </h2>\n\n        <!-- <img src="{{values.cancel}}" alt=""> -->\n\n      </div>\n\n      <!-- <button  text-center ion-button icon-left clear color="button-color" icon-only class="has-icon icon-only" small text-uppercase >\n\n        Ver detalles\n\n      </button> -->\n\n    </div>\n\n  </div>\n\n</ion-content>\n\n'/*ion-inline-end:"D:\desktop\numu\homer\homerproveedor\src\pages\end-orders\end-orders.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_functions__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_onesignal__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__tabs_tabs__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__product_product__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__post_post__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_geolocation_ngx__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_native_geocoder__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__tabs_tabs__ = __webpack_require__(84);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__ionic_native_geolocation_ngx__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_native_geocoder__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__tabs_tabs__ = __webpack_require__(84);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_products_providers_pages_products_providers__ = __webpack_require__(207);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var NewProductPage = /** @class */ (function () {
    function NewProductPage(nav, navParams, values, alert, service, config, transfer) {
        ...
        this.cost = 0;
        this.default_date_availability = "non-available";
        this.duration_type = "customer";
        ...
        if (navParams.data.id) {
            ...
            navParams.data.availability.map(function (result) {
                var day = result.type.split(':');
                if (day[0] == "custom" || parseInt(day[1]) > 0) {
                    console.log(day);
                    console.log(_this.days[day[1]].name);
                    _this.availability.push({
                        ...
                        from: result.from,
                        to: result.to,
                        nameDay: _this.days[parseInt(day[1]) - 1].name
                    });
                }
            });
    ...
    NewProductPage.prototype.compareFn = function (e1, e2) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.name != undefined && this.description != undefined && this.short_description != undefined &&
                            this.block_cost != undefined && this.selectedCate.length != 0 && this.availability.length != 0)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.service.updateProduct(this.data, this.navParams.data.id)];
                    case 1:
                        result = _a.sent();
                        if (result === 200) {
    ...
    NewProductPage.prototype.onChangeday = function (evt) {
        this.daySelected = evt.value;
        this.dayNameSelected = evt.name;
    };
    NewProductPage.prototype.addAvailabilityRange = function () {
    ...
    NewProductPage.prototype.addAvailabilityDay = function () {
        if (this.availability.length == 0) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_service_category_service__ = __webpack_require__(38);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CategoryServicePage = /** @class */ (function () {
    ...
    CategoryServicePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-category-service',template:/*ion-inline-start:"D:\desktop\numu\homer\homerproveedor\src\pages\category-service\category-service.html"*/'<ion-header style="background-color: #72A9AE;">\n  <ion-toolbar color="header">\n    <button ion-button menuToggle >\n      <ion-icon >\n        <img class="logo-login" src="{{values.iconMenu}}">\n      </ion-icon>\n    </button>\n    <ion-title class="logo-title">\n      <div>\n        <img width="200" src="{{values.homerLogoP}}" />\n      </div>\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n<ion-content  padding >\n  <div class="sub-header">\n    <h1>Mis Servicios</h1>\n  </div>\n  <ion-list *ngIf="service.categories">\n    <ion-item *ngFor="let item of service.mainCategories"  class="card2">\n      <ion-thumbnail item-left>\n        <img src="{{item.image.src}}" />\n      </ion-thumbnail>\n      <ion-label  class="heading text-center" style="font-size: 18px; font-weight: 900;">\n        {{item.name}}\n      </ion-label>\n\n      <ion-checkbox item-right color="dark" (click)="addServicio($event,item.id)"></ion-checkbox>\n\n    </ion-item>\n  </ion-list>\n  <div class="row-btn">\n    <button ion-button  (click)="updateCategory()">Actualiza Tus Servicios</button>\n  </div>\n</ion-content>\n'/*ion-inline-end:"D:\desktop\numu\homer\homerproveedor\src\pages\category-service\category-service.html"*/,
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pages_account_booking_details_booking_details__ = __webpack_require__(204);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__pages_account_test_test__ = __webpack_require__(205);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_account_wishlist_wishlist__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_account_account_account__ = __webpack_require__(203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_dash_proveedor_dash_proveedor__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__pages_chat_chat__ = __webpack_require__(199);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_checkout_order_summary_order_summary__ = __webpack_require__(190);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__pages_products_products__ = __webpack_require__(60);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__pages_search_search__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_tabs_tabs__ = __webpack_require__(84);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__pages_pages_products_providers_pages_products_providers__ = __webpack_require__(207);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__ionic_native_in_app_browser__ = __webpack_require__(177);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__ionic_native_native_storage__ = __webpack_require__(169);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__providers_service_category_service__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__providers_service_checkout_service__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__providers_service_config__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__providers_service_functions__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_50__providers_service_product_service__ = __webpack_require__(192);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_57__ionic_native_email_composer__ = __webpack_require__(206);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_62__ngx_translate_core__ = __webpack_require__(100);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_63__ngx_translate_http_loader__ = __webpack_require__(927);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_64__ionic_native_onesignal__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_65__ionic_native_http__ = __webpack_require__(99);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_67__ionic_native_geolocation_ngx__ = __webpack_require__(82);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_68__ionic_native_native_geocoder__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_69__ionic_native_background_mode__ = __webpack_require__(538);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_70_ngx_socket_io__ = __webpack_require__(81);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ionic_native_onesignal__ = __webpack_require__(59);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_products_products__ = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_checkout_order_summary_order_summary__ = __webpack_require__(190);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__pages_account_wishlist_wishlist__ = __webpack_require__(202);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__ionic_native_native_storage__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_account_account_account__ = __webpack_require__(203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_account_booking_vendor_booking_vendor__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_account_test_test__ = __webpack_require__(205);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_tabs_tabs__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30_rxjs_observable_timer__ = __webpack_require__(183);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__pages_pages_products_providers_pages_products_providers__ = __webpack_require__(207);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__pages_category_service_category_service__ = __webpack_require__(569);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__providers_service_category_service__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__pages_dash_proveedor_dash_proveedor__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35_ngx_socket_io__ = __webpack_require__(81);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MyApp = /** @class */ (function () {
    function MyApp(socket, CategoryService, statusBar, splashScreen, alertCtrl, config, oneSignal, emailComposer, appRate, platform, service, values, translateService, socialSharing, nativeStorage) {
        var _this = this;
        this.socket = socket;
        this.CategoryService = CategoryService;
    ...
    MyApp.prototype.handleService = function (results) {
        ...
        if (this.values.isLoggedIn) {
            if (this.values.subscription.length > 0) {
                ...
                this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_34__pages_dash_proveedor_dash_proveedor__["a" /* DashProveedorPage */]);
            }
            else {
                console.log('entro:', this.values.isLoggedIn);
                this.nav.setRoot(__WEBPACK_IMPORTED_MODULE_34__pages_dash_proveedor_dash_proveedor__["a" /* DashProveedorPage */]);
    ...
    MyApp.prototype.loginHomerSetUp = function () {
        var _this = this;
        this.CategoryService.getProductsByIdVendor2()
            .then(function (result) {
            if (result.length > 0) {
    ...
    MyApp.prototype.pagesProductsProviders = function () {
        this.nav.push(__WEBPACK_IMPORTED_MODULE_31__pages_pages_products_providers_pages_products_providers__["a" /* PagesProductsProvidersPage */]);
    };
    ...
    MyApp.prototype.support = function () {
        this.nav.push(__WEBPACK_IMPORTED_MODULE_27__pages_pages_support_pages_support__["a" /* PagesSupportPage */]);
    };
...
var Values = /** @class */ (function () {
    function Values() {
        ...
        this.pen = "assets/image/logo.png";
        this.cancel = "assets/image/cancel.png";
        this.homerCircle = "assets/image/homer-circle.png";
        this.logoHomer = "assets/image/logoHomer.png";
        this.logoMenu = "assets/image/logo-fondo-blanco.png";
        this.iconMenu = "assets/image/menu.png";
        this.logoLogin = "assets/image/logoLogin.png";
        this.logoLogin2 = "assets/image/logoLogin2.png";
        this.homerLogoP = "assets/image/homerLogoP.png";
        ...
        this.headerLogin2 = "assets/image/header-login2.png";
        this.headerLogin3 = "assets/image/header-login3.png";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__home_home__ = __webpack_require__(191);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__products_list_products_list__ = __webpack_require__(560);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pages_account_wishlist_wishlist__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__cart_cart__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pages_account_account_account__ = __webpack_require__(203);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_account_test_test__ = __webpack_require__(205);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_service_values__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_service_service__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__account_booking_details_booking_details__ = __webpack_require__(204);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
