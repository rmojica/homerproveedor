...
var ProductsListPage = /** @class */ (function () {
    function ProductsListPage(geolocation, nativeGeocoder, zone, toastCtrl, nav, service, values) {
    ...
    ProductsListPage.prototype.getAddressFromCoords = function (lattitude, longitude) {
        var _this = this;
        ...
        this.nativeGeocoder.reverseGeocode(lattitude, longitude, options)
            ...
            for (var _i = 0, responseAddress_1 = responseAddress; _i < responseAddress_1.length; _i++) {
                var value = responseAddress_1[_i];
                _this.address += value + ", ";
            }
